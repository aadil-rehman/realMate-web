...
const TermsOfService = () => {
	return (
		<div className="p-6 max-w-4xl mx-auto text-sm leading-relaxed mt-20">
			...
			<p>
				By accessing or using RealMate, you agree to be bound by these Terms of
				Service.
			</p>
			...
			<p>
				Users retain ownership of the content they post. However, by posting on
				RealMate, you grant us a non-exclusive license to display and share that
				content within the platform.
			</p>

			<h2 className="mt-4 font-semibold">4. Safety and Authenticity</h2>
			<p>
				RealMate strives to ensure user authenticity. We prohibit fake profiles
				and take safety seriously. Users should report suspicious activity
				immediately.
			</p>
